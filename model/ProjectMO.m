...
lattice = compileLattice(lattice,@(scenario)nldsMO(scenario,var,GeneratorConv,GeneratorPS,GeneratorWS,Loads,Bus,Lines,UC),params) ;
...
disp('Saving...');
save('transmission_mo') ;   %redispatch
disp('All Done.');
