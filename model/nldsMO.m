function [cntr, obj] = nldsMO(scenario, var, GeneratorConv,GeneratorPS,GeneratorWS,Loads,Bus,Lines, UC)
...
%cntr= [satisifyDemand; bounds; errorDynamics; productionCost; Shedding; flowCalc; angleZero; pumpedStorage];
%cntr= [satisifyDemand; Shedding; errorDynamics; common_cstr{t}];
