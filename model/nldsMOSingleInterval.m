function [cntr, obj] = nldsMOSingleInterval(scenario, var, GeneratorConv,GeneratorPS,GeneratorWS,Loads,Bus,Lines, UC)
...
%     bounds = [
%         bounds;
%         sum(ruc(:,t)) >= ProductionWS(t)*e(t) - (e(t)*0.9994 + 0.00057)*0.9746*ProductionWS(t+1)
%         sum(rdc(:,t)) >= (e(t)*0.9994 + 0.00057)*1.0254*ProductionWS(t+1) - ProductionWS(t)*e(t)
%         ];
% end
